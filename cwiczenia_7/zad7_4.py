from cwiczenia_6.zad6_2 import Point
...
class Triangle:
    ...
    def __init__(self, x1, y1, x2, y2, x3, y3):
        ...
        if area == 0:
            raise ValueError("Punktysą współliniowe-nie da się utwożyć trójkąta")
...
class TestPoint(unittest.TestCase): 
    ...
    def test__init__(self): 
        ...
        self.assertEqual(Triangle(0, 0, 1, 1, 2, 2), "Punktysą współliniowe-nie da się utwożyć trójkąta")
